 ...
 */
import APP_CONFIG from '../config/app.config.js?v=50';
import CAMPAIGN from '../config/campaign.config.js?v=50';
import MEDIA from '../config/media.config.js?v=50';
import { VISA, DEPOSIT, getRetailPrice } from '../config/pricing.config.js?v=50';
import PACKAGES from '../config/packages.config.js?v=50';
import QUIZ_STEPS, { PROGRESS_STEPS, REFINE_STEPS } from '../config/quiz.config.js?v=50';
import Store from './state.js?v=50';
import I18n from './i18n.js?v=50';
import { decide } from './routing.js?v=50';
import Analytics from './analytics.js?v=50';
import Payment from './payment.js?v=50';
...
function pricingFor(pkgId, f) {
  ...
  var priceDuration = duration === '21+' ? 21 : duration; // 21+ prices off the 21-day tier
  var r = getRetailPrice(pkgId, priceDuration);
